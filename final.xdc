...
set_property PACKAGE_PIN W7 [get_ports {ssd_seg[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ssd_seg[0]}]
set_property PACKAGE_PIN W6 [get_ports {ssd_seg[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ssd_seg[1]}]
set_property PACKAGE_PIN U8 [get_ports {ssd_seg[2]}]
...
set_property PACKAGE_PIN U5 [get_ports {ssd_seg[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ssd_seg[4]}]
set_property PACKAGE_PIN V5 [get_ports {ssd_seg[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ssd_seg[5]}]
set_property PACKAGE_PIN U7 [get_ports {ssd_seg[6]}]
